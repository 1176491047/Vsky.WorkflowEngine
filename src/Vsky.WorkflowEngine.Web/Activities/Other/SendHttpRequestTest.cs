...
{
    public class SendHttpRequestTest : Activity, IActivityPropertyOptionsProvider
    {
        ...
        {
            _httpClient = httpClientFactory.CreateClient(nameof(SendHttpRequestTest));
            _parsers = parsers;
        ...
        [ActivityInput(
            ...
            SupportedSyntaxes = new[] { SyntaxNames.Literal, SyntaxNames.JavaScript, SyntaxNames.Liquid },
            UIHint = ActivityInputUIHints.Dropdown,
            OptionsProvider = typeof(SendHttpRequestTest)
        )]
