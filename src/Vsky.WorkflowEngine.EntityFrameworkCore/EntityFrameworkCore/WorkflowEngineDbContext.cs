...
public class WorkflowEngineDbContext :
    AbpDbContext<WorkflowEngineDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(WorkflowEngineConsts.DbTablePrefix + "YourEntities", WorkflowEngineConsts.DbSchema);
        ...
        {
            builder.Entity<WorkflowEngineSettingsManage>(b =>
            {
                b.ToTable(WorkflowEngineConsts.DbTablePrefix + "WorkflowEngineSettingsManages", WorkflowEngineConsts.DbSchema);
                b.ConfigureByConvention();
                b.Property(x => x.ProjectName).HasColumnName(nameof(WorkflowEngineSettingsManage.ProjectName));
                b.Property(x => x.Description).HasColumnName(nameof(WorkflowEngineSettingsManage.Description));
